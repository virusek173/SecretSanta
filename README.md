...
- 🤖 Personalized message generation using OpenAI GPT-5 (Polish language)
...
- 🔒 Optional log encryption for privacy
- 🧪 Unit tests (Jest)
...
│   │   └── encryption.ts          # Log encryption utilities
│   ├── config/
